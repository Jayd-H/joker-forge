...
export const JOKERS = [
  ...
  { key: "j_space_joker", label: "Space Joker" },
  { key: "j_egg", label: "Egg" },
  ...
  { key: "j_trading_card", label: "Trading Card" },
  { key: "j_flash", label: "Flash Card" },
  { key: "j_popcorn", label: "Popcorn" },
  { key: "j_spare_trousers", label: "Spare Trousers" },
